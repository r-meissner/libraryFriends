    ...
    <div className="drawer lg:drawer-open">
          ...
          <div className="m-4 mr-8 w-11/12">
            <div className="grid grid-cols-8 grid-rows-2 gap-4 ">
              ...
              <div className="col-span-3 row-span-1 flex items-center justify-center flex-wrap">
                <div className="badge badge-primary badge-lg">owned by username</div>
              </div>
              ...
              {/* borrowed since */}
              <div className="col-span-3 row-span-1 flex items-center justify-center flex-wrap">
                <div className="badge badge-primary badge-lg">borrowed since DD/MM/YYYY</div>
              </div>
            </div>
      ...
      <div className="drawer-side">
        ...
        <ul className="menu bg-base-200 text-base-content min-h-full w-60 pt-4 p-2">
          ...
          <li><Link to="/mybooks"><h1>MY BOOKS</h1></Link></li>
          <li><Link to="/myborrowedbooks"><h1>BORROWED BOOKS</h1></Link></li>
          <li><Link to="/mylentbooks"><h1>LENT BOOKS</h1></Link></li>
        </ul>
      </div>
    </div>
